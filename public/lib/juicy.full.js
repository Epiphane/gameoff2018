...
(function(window, document) {
   ...
   Game.resize = function() {
      ...
      var width  = parent.width  || parent.offsetWidth;
      var height = parent.height || parent.offsetHeight;
   ...
   Game.render = function() {
      ...
      Game_state.render(Game_context, Game_canvas.width, Game_canvas.height);
